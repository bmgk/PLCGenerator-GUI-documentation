...
An element without parameters.

### <strong style={{color: '#ff9800'}}>Yellow</strong>

An Element partially configured. Opened.

### <strong style={{color: '#43a047'}}>Green</strong>

An Element with configured all parameters. Opened.

### <strong style={{color: '#2196f3'}}>Blue</strong>

An Element is updated right after accepting parameters from another structural element. Opened.

### <strong style={{color: '#f50057'}}>Purple</strong>
